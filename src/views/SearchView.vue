  ...
  <div class="layout-main">
    ...
    <div class="search-condition">
      ...
      <a-row class="condition-row">
        ...
        <div>
          <span
            v-for="cate in presetCategories"
            :key="cate"
      ...
      <a-row class="condition-row" align="middle">
        ...
        <a-col style="margin-left: auto">
          <a-row align="middle">
            ...
            <!-- 分页条 默认每页大小为24 -->
            <a-col
              ><span>共 {{ total }} 件商品</span></a-col
            >
            <a-col>
              <a-pagination
                v-model:current="searchParams.pageNo"
                @change="searchCommodity"
                :total="Number(total)"
      ...
      <a-row class="condition-row">
        ...
        <a-col>
          <!-- 条件标签 -->
          <a-tag v-if="searchParams.brand" closable @close="setBrand('')">{{
            searchParams.brand
          }}</a-tag>
          <a-tag v-if="searchParams.category" closable @close="setCategory('')"
            >{{ searchParams.category }}
          </a-tag>
          ...
          <!-- 清空标签 -->
          <a-tag color="red" style="cursor: pointer; font-size: 14px" @click="resetCondition"
            >清除</a-tag
          >
        </a-col>
      </a-row>
              ...
              <a-card-meta>
                ...
                <template #description>
                  ...
                  <div style="margin-top: 5px">
                    ...
                    <a-tag :color="item.status === 2 ? `red` : ``" style="margin-left: 10px"
