      ...
      <a-form :model="configForm" :label-col="{ span: 6 }" :wrapper-col="{ span: 18 }">
        ...
        <a-form-item label="API地址">
          <div class="url-input-group">
            <!-- URL下拉选择器 -->
            <a-select
              v-model:value="configForm.currentUrl"
              style="width: 100%"
              placeholder="请选择或输入API地址"
              :options="urlOptions"
              show-search
              allow-clear
            >
              ...
              <template #dropdownRender="{ menuNode: menu }">
                ...
                <div style="padding: 8px 12px">
                  <a-input
                    ...
                    placeholder="请输入API地址，例如: http://localhost:8080"
                    @pressEnter="addUrl"
                  >
                    <template #suffix>
        ...
        <a-form-item :wrapper-col="{ offset: 6 }">
          ...
          <a-button @click="testConnection" :loading="testing" style="margin-left: 8px"
            >测试连接</a-button
          >
        </a-form-item>
      </a-form>
...
import { deleteUrl, getUrlConfig, updateConfig, updateUrlList } from '@/utils/config'
